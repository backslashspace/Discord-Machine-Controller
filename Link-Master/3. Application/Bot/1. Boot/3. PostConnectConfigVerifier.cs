...
namespace Link_Master.Worker
{
    internal static partial class Bot
    {
        ...
        internal static void VerifyConfig()
        {
            ...
            {
                Log.FastLog("Post-Connect", "guildID was invalid, make sure the config contains a valid server id / make sure the bot is on said server", LogSeverity.Critical);
            ...
            if (Bot.LogChannelID != null)
            {
                try
                {
                    ...
                    if (CurrentConfig.LogChannel == null)
                    {
                        ...
                        $"discord reports channel not found", LogSeverity.Critical);
